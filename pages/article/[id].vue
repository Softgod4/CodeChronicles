<template>
  ...
  <section v-else-if="post && Array.isArray(post)">
    <Container class="border-r border-l border-solid border-color-border p-4 text-white">
      <article class="font-medium mb-2 flex md:flex-row flex-col-reverse justify-between md:items-center items-start">
        <div class="md:w-1/2 w-full post-preview relative">
          ...
          <button class="like-btn flex justify-center items-start mt-4" @click="setLike()">
